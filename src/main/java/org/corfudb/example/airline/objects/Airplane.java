...
/**
 * This class represents airplanes that the airline owns.
 */
@CorfuObject(objectType= ObjectType.STATELESS,
            constructorType= ConstructorType.PERSISTED)
public class Airplane {

    /** The type of aircraft this plane is. */
    public final Aircraft aircraft;
    /** The tail number used on this plane.*/
    public final String tailNumber;

    public Airplane(String tailNumber, Aircraft aircraft) {
    ...
    public boolean equals(Object obj) {
        return obj instanceof Airplane && ((Airplane) obj).tailNumber.equals(tailNumber);
    }
